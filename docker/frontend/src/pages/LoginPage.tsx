...
export default function LoginPage() {
  ...
  const { login, isLoading, error, setToken } = useAuthStore()
  ...
  useEffect(() => {
    ...
    if (errorParam) {
      setLocalError('Erreur de connexion Google: ' + errorParam)
    }
  }, [searchParams, navigate, setToken])

  const handleGoogleLogin = () => {
    window.location.href = 'https://arlink.online/api/auth/google'
  }
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button 
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-3 border border-dark-medium rounded-lg text-cream hover:border-gold transition"
                >
